...
int counter=0;
using namespace std;
float _angle = 0,dv1=0.5,deltax=0.0,deltaz=0.0,deltay=0.0;
...
float fx,fy,fz,rightx,righty,rightz,ydec=0.0;
...
//	glEnable(GL_LIGHT0);
	...
	_textureId[7] = loadTexture7(image7);
	delete image7;
...
//	glNormal3f(0.0,1.0f,0.0f);
	...
	glBegin(GL_QUADS);	
	glTexCoord2f(0.0f,0.0f);
	glVertex3f(-100.0f ,-40.0f,-5000.0f);
	glTexCoord2f(1.0f,0.0f);
	glVertex3f(-100.f,80.0f,-5000.0f);
	glTexCoord2f(0.0f,1.0f);
	glVertex3f(120.0f ,-40.0f,-5000.0f);
	glTexCoord2f(1.0f,1.0f);
	glVertex3f(120.0f ,80.0f,-5000.0f);
	glEnd();
	glDisable(GL_TEXTURE_2D);
...
//drawBitmapText( level,3.0f,4.0f,-0.1f);
